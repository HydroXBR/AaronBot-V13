...
client.on('interactionCreate', async (interaction) => {
	if(bannedUsers.includes(interaction.member.user.id)) return interaction.reply('Infelizmente, você foi banido e não pode usar meus comandos :confused: | Se achar que isso é um erro, contate-me em https://abre.ai/aaronbotsite');
